/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b5c79218e8f268eaf15b5e97aa8ee5c1)
// Runtime types generated with workerd@1.20260708.1 2026-07-15 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	ASSETS: Fetcher;
	DATA_ENV: "local-e2e" | "remote-d1";
	NATIVE_ALLOWED_ORIGINS: "capacitor://localhost,https://localhost,http://localhost";
	STORE_VERIFICATION_ENABLED: "false";
	VITE_GOOGLE_WEB_CLIENT_ID: string;
	GAME_ROOMS: DurableObjectNamespace<import("./src/server/worker").GameRoom>;
	HIDE_SEEK_ROOMS: DurableObjectNamespace<import("./src/server/worker").HideSeekRoom>;
	RANKED_QUEUE: DurableObjectNamespace<import("./src/server/worker").RankedQueue>;
	SOCIAL_PRESENCE: DurableObjectNamespace<import("./src/server/worker").SocialPresence>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server/worker");
		durableNamespaces: "GameRoom" | "RankedQueue" | "SocialPresence" | "HideSeekRoom";
	}
	interface E2eEnv {
		DB: D1Database;
		ASSETS: Fetcher;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DATA_ENV" | "NATIVE_ALLOWED_ORIGINS" | "STORE_VERIFICATION_ENABLED" | "VITE_GOOGLE_WEB_CLIENT_ID">> {}
}
