...
function buildingFallbackArt(kind: BuildingKind): string {
  ...
  const art: Record<BuildingKind, { accent: string; detail: string }> = {
    ...
    'overload-capacitor': { accent: '#74d8ff', detail: '<rect x="75" y="60" width="106" height="96" rx="24" fill="#427bb0"/><path d="M132 69l-30 49h24l-8 33 38-51h-25z" fill="#fff39a"/>' },
    'turret-enhancer': { accent: '#89f0c8', detail: '<rect x="66" y="71" width="124" height="77" rx="18" fill="#579c86"/><path d="M86 109h84m-42-25v50" stroke="#e4fff4" stroke-width="12" stroke-linecap="round"/>' },
    'door-anchor': { accent: '#f1a46b', detail: '<path d="M128 45l48 48v67H80V93z" fill="#a85e50" stroke="#ffe1a3" stroke-width="9"/><path d="M128 73v59m-25-29h50" stroke="#fff2b4" stroke-width="9"/>' },
    'reflect-mirror': { accent: '#a7e9ff', detail: '<ellipse cx="128" cy="107" rx="48" ry="62" fill="#72b9d7" stroke="#e8fbff" stroke-width="9"/><path d="M107 82l35-20m-47 52l65-37" stroke="#fff" stroke-width="7" opacity=".8"/>' },
    'power-panel': { accent: '#ffd66f', detail: '<rect x="62" y="65" width="132" height="86" rx="17" fill="#4f7293" stroke="#d4f4ff" stroke-width="8"/><circle cx="98" cy="108" r="13" fill="#ffdc73"/><circle cx="128" cy="108" r="13" fill="#8ef0cb"/><circle cx="158" cy="108" r="13" fill="#f88db1"/>' },
    'cursed-contract': { accent: '#e688bd', detail: '<path d="M78 50h100v112H78z" fill="#5e3a65" stroke="#ffd3ee" stroke-width="8"/><path d="M103 81h51m-51 24h40m-40 24h51" stroke="#ffd8f1" stroke-width="8" stroke-linecap="round"/>' },
    'soul-vial': { accent: '#9beaff', detail: '<path d="M101 51h54v25l20 29c13 36-13 57-47 57s-60-21-47-57l20-29z" fill="#5d9fd2" stroke="#e9feff" stroke-width="8"/><circle cx="128" cy="121" r="23" fill="#c5f5ff"/>' },
    'hide-and-seek-doll': { accent: '#c6a2ff', detail: '<circle cx="128" cy="103" r="51" fill="#a98ee8" stroke="#ebdeff" stroke-width="8"/><path d="M84 82Q49 74 61 130M172 82q35-8 23 48" fill="#c5b0ff" stroke="#ebdeff" stroke-width="9"/><path d="M100 100c-13-15 16-25 10-4-3 11-17 4-7-5m53 9c13-15-16-25-10-4 3 11 17 4 7-5" fill="none" stroke="#573a92" stroke-width="8" stroke-linecap="round"/><path d="M100 147q28 18 56 0" fill="none" stroke="#f4dcff" stroke-width="9" stroke-linecap="round"/><path d="M93 145l-21 28m91-28 21 28" stroke="#a98ee8" stroke-width="22" stroke-linecap="round"/>' },
    'ghost-lure-beacon': { accent: '#67e8ff', detail: '<ellipse cx="128" cy="142" rx="67" ry="28" fill="#171d58" stroke="#83f4ff" stroke-width="8"/><circle cx="128" cy="111" r="39" fill="#25206c" stroke="#a684ff" stroke-width="9"/><path d="M128 67v61m-31-31h62" stroke="#6ff4ff" stroke-width="8" stroke-linecap="round"/><path d="M128 48c-20 20-14 42 0 42s20-22 0-42z" fill="#7cf5ff" stroke="#e7feff" stroke-width="6"/>' },
    ...
    'random-item': { accent: '#ffd66d', detail: '<path d="M72 126h112v40H72z" fill="#875a45" stroke="#ffe8a4" stroke-width="8"/><path d="M128 48l38 45-38 47-38-47z" fill="#ffd35f" stroke="#fff1b8" stroke-width="8"/><circle cx="128" cy="93" r="12" fill="#fff7d3"/>' },
  };
  const spec = art[kind];
