...
function cosmeticCollectionScreen(
  ...
  const selectedSlot: Exclude<CosmeticSlot, "turret"> =
    activeSlot === "skin" ? "skin" : "character";
  const currentAccount = account;
