...
export const EVENT_MISSIONS = [
  ...
  },
  {
    ...
    title: '랭크전 출전',
    description: '오늘 랭크전을 1회 끝까지 완료하세요.',
    target: 1,
    rewardPoints: 75,
  },
  {
    ...
    metric: 'login-days',
    title: '주간 출석 생존자',
    description: '월요일부터 일요일 사이 5일 접속하세요.',
    target: 5,
    rewardPoints: 50,
  },
  {
    ...
    metric: 'stage-clears',
    title: '주간 방어 교대',
    description: '이번 주 스테이지를 5회 클리어하세요.',
    target: 5,
    rewardPoints: 100,
  },
  {
    ...
    metric: 'stage-clears',
    title: '숙련 생존자',
    description: '이번 주 스테이지를 10회 클리어하세요.',
    target: 10,
    rewardPoints: 150,
  },
  {
    ...
    metric: 'stage-clears',
    title: '불침번의 증명',
    description: '이번 주 스테이지를 20회 클리어하세요.',
    target: 20,
    rewardPoints: 200,
  },
  {
    ...
    metric: 'ranked-completions',
    title: '주간 랭크 작전',
    description: '이번 주 랭크전을 5회 끝까지 완료하세요.',
    target: 5,
    rewardPoints: 150,
  },
