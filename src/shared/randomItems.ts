...
export const RANDOM_ITEMS: readonly RandomItemDefinition[] = [
  ...
  { id: 'royal-money-tree', label: '왕실 돈나무', description: '매초 골드 100을 생산합니다.', rarity: 'legendary', weight: 0.18, effect: { goldPerSecond: 100 } },
  { id: 'golden-goose', label: '황금 거위', description: '매초 골드 50을 생산합니다.', rarity: 'legendary', weight: 0.34, effect: { goldPerSecond: 50 } },
  ...
  { id: 'gold-frog', label: '황금 두꺼비', description: '매초 골드 5를 생산합니다.', rarity: 'epic', weight: 2.1, effect: { goldPerSecond: 5 } },
  ...
  { id: 'black-market-coin', label: '암시장 금화', description: '매초 골드 10을 생산합니다.', rarity: 'epic', weight: 2.4, effect: { goldPerSecond: 10 } },
  { id: 'moon-piggy-bank', label: '달빛 저금통', description: '매초 골드 20을 생산합니다.', rarity: 'epic', weight: 1.9, effect: { goldPerSecond: 20 } },
  { id: 'candle-coin-chest', label: '도깨비 촛불 금고', description: '매초 골드 5를 생산합니다.', rarity: 'rare', weight: 3.9, effect: { goldPerSecond: 5 } },
  ...
  { id: 'silver-moth', label: '은빛 나방', description: '매초 골드 2를 생산합니다.', rarity: 'rare', weight: 5.5, effect: { goldPerSecond: 2 } },
  { id: 'lucky-coin-pouch', label: '행운 동전 주머니', description: '매초 골드 2를 생산합니다.', rarity: 'rare', weight: 4.3, effect: { goldPerSecond: 2 } },
  ...
  { id: 'copper-pig', label: '구리 저금통', description: '매초 골드 1을 생산합니다.', rarity: 'uncommon', weight: 10.5, effect: { goldPerSecond: 1 } },
  { id: 'coin-candle', label: '동전 촛불', description: '매초 골드 1을 생산합니다.', rarity: 'uncommon', weight: 10.5, effect: { goldPerSecond: 1 } },
