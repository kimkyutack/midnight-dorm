...
export interface StageTheme {
  ...
  lightA: number;
  lightB: number;
  /** Dedicated material art prevents later tiers reading as only a recolour. */
  floorAsset: string;
  wallAsset: string;
}
...
export const STAGE_THEMES: Readonly<Record<StageThemeId, StageTheme>> = {
  hospital: {
    ...
    floorAsset: '/assets/environment/ward-floor-tile.png', wallAsset: '/assets/environment/ward-wall-surface.png',
  },
  forest: {
    ...
    floorAsset: '/assets/environment/forest-floor-tile.png', wallAsset: '/assets/environment/forest-wall-surface.png',
  },
  ice: {
    ...
    floorAsset: '/assets/environment/ice-floor-tile.png', wallAsset: '/assets/environment/ice-wall-surface.png',
  },
  desert: {
    ...
    floorAsset: '/assets/environment/desert-floor-tile.png', wallAsset: '/assets/environment/desert-wall-surface.png',
  },
  junkyard: {
    ...
    floorAsset: '/assets/environment/junkyard-floor-tile.png', wallAsset: '/assets/environment/junkyard-wall-surface.png',
  },
  occult: {
    ...
    floorAsset: '/assets/environment/occult-floor-tile.png', wallAsset: '/assets/environment/occult-wall-surface.png',
  },
  void: {
    ...
    floorAsset: '/assets/environment/void-floor-tile.png', wallAsset: '/assets/environment/void-wall-surface.png',
  },
};
