...
1. 최초 실행 시 복도 추격 티저를 본 뒤 계정을 만들거나 로그인합니다. 개인/멀티 등급, XP와 스테이지 진행도는 D1에 저장됩니다.
2. 게임 홈에서 로그인 정보와 최고 표시 등급을 확인하고 `게임 시작`을 누릅니다.
3. 개인/멀티 모드와 해금된 스테이지를 고르고 새 방을 만들면 8자리 초대 코드가 발급됩니다.
4. 다른 기기에서 같은 URL을 열고 초대 코드로 참가합니다.
5. 참가자가 준비하면 방장이 20초 준비 시간을 시작합니다.
...
- 개인 등급은 시작 자원과 이동속도, 포탑 최대 레벨을 높입니다. 문은 등급과 무관하게 15레벨까지 올릴 수 있고, 베테랑부터 희귀 천둥포를 설치할 수 있습니다.
