...
- `src/shared/progression.ts`: 6개 일반 진행 등급, 190개 스테이지, 난이도 곡선과 혼자하기 등급 혜택
...
- 스테이지는 `쉬움 1`, `노말 1~5`, `어려움 1~5`, `악몽 1~10`, `지옥 1~10`, `불지옥 1~15`, `에픽 1~20`, `신화 1~25`, `레전더리 1~99` 순서의 총 190개입니다.
